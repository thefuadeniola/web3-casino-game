      ...
      <div className="bg-background border rounded-xl shadow-lg max-w-md w-full overflow-hidden animate-in fade-in zoom-in duration-200">
        ...
        <div className="p-6 space-y-4">
          <div className="space-y-2">
            <p className="text-sm text-white">Copy this wallet address & fund with ETH on Sepolia ETH</p>
            <div className="flex items-center gap-2 p-3 bg-muted rounded-lg border">
              <code className="text-xs break-all flex-1 font-mono text-white">{walletAddress}</code>
